...
function optionsframework_page() {
	...
	<?php echo get_screen_icon( $screen = 'settings'); ?> 
		<div class="extern-links">
			<a class="icon-a icon-gallery" href='http://wrapbootstrap.com/user/littlesparkvt' ><span class="icon"><span>Themes gallery</span></span></a>
			<a class="icon-a icon-support" href='http://www.littlesparkvt.com' ><span class="icon"><span>Support</span></span></a>
			<a class="icon-a icon-documentation" href='http://littlesparkvt.com/support/' ><span class="icon"><span>Documentation</span></span></a>
		</div>
		<br class="clear" /> 
